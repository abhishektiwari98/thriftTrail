    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark py-3 sticky-top">
            <div className="container">
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/"> ThriftTrail</NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="buttons text-center">
                        ...
                        <NavLink to="/search" className="btn btn-outline-light m-2"><i className="fa fa-search mr-1"></i> Search</NavLink>
                    </div>
                </div>
